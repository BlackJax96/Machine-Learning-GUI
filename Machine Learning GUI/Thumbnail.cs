...
namespace MLUI
{
    ...
    public class WindowsThumbnailProvider
    {
        ...
        public static Bitmap GetThumbnail(string fileName, int width, int height, EThumbnailOptions options)
        {
        ...
        private static IntPtr GetHBitmap(string fileName, int width, int height, EThumbnailOptions options)
        {
